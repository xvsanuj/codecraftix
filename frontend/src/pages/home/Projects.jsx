...
const Projects = ({ setIsHover, setText }) => {
  useGSAP(() => {
      ...
      <div className="w-full rounded-2xl mt-20 overflow-hidden flex gap-36">
        <div className="flex flex-col gap-36">
          <div className="project-cards-1">
            <div onMouseMove={() => {setText('Show'); setIsHover(true)}} onMouseLeave={() => {setIsHover(false); setText("")}} className="h-[70vh] cursor-pointer overflow-hidden rounded-3xl w-[25vw] bg-zinc-600">
